...
export default function Main() {
    return (
        <>
            <Alert type="danger">
                <ul>
                    <li>Errore 404 in chiamata</li>
                    <li>I dati ricevuti sono vuoti</li>
                    <li>La chiamata e' rimasta in attesa troppo a lungo</li>
                    <li>L'input di ricerca non e' ben formato</li>
                </ul>
            </Alert>
            <main>
